...
//
//    static {
//        passUrls.add("/user/addUser");//注册
//        passUrls.add("/user/add");//注册
//        passUrls.add("/user/addFarmer");//注册
...
//
//        RedisUtil.updateSessionExpireTime( hashOperations,sessionCookieVal);//存在则更新redis过期时间
